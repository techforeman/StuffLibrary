...
namespace Stuff_Library.DAL
{
	public class StoreInitializer : MigrateDatabaseToLatestVersion<StoreContext, Configuration>
	{
		...
		public static void SeedStoreData(StoreContext context)
		{
			...
			{
				new Category() { CategoryID = 1, Name = "C# - desktop", IconFilename = "C#desktop.png"},
				new Category() { CategoryID = 2, Name = "C# - web", IconFilename = "C#web.png"},
				...
				new Category() { CategoryID = 7, Name = "Graphic / Design", IconFilename = "Design.png"},
				new Category() { CategoryID = 8, Name = "Self-development", IconFilename = "SelfDev.png"},
			...
			var courses = new List<Course>
			{
				...
				new Course() { CourseID = 4, AuthorName = "Stasik", CourseTitle = "Pole samo się nie orze",  CovertFileName = "4.jpg", IsBestVoted = true, DateAdded = new DateTime(2014, 03, 11), CategoryID = 2 },
			};
